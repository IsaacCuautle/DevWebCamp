        ...
        <div class="evento__informacion">
            ...
            <div class="evento__autor-info">
                <picture>
                    ...
                    <source srcset="<?php echo $_ENV['HOST']; ?>/img/speakers/<?php echo $evento->ponente->imagen;?>.png" type="image/webp">
                    <img  class="evento__imagen-autor" width="200" height="300" loading="lazy" 
